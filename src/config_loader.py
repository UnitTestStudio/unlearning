...
def generate_activations_file_path(config):
    ...
    return f"/exports/eddie/scratch/mdisley2/data/activations/{model_name}_{activations_label}_activations.json"
...
def generate_model_path(config, model_type):
    ...
    if model_type == "pruned":
        return f"/exports/eddie/scratch/mdisley2/models/{model_name}_{activations_label}activations_{prune_ratio}pruned_{model_type}"
    elif model_type == "retrained":
        return f"/exports/eddie/scratch/mdisley2/models/{model_name}_{activations_label}activations_{prune_ratio}pruned_{model_type}_{config['retraining']['num_train_epochs']}epochs"
...
def load_config(config_path='config.json'):
    ...
    config["retraining"]["train_dataset_path"] = "/exports/eddie/scratch/mdisley2/data/filtered_train"
    config["retraining"]["val_dataset_path"] =  "/exports/eddie/scratch/mdisley2/data/filtered_val"
    return config
